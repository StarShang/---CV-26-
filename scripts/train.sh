...
config=configs/vitbase_jointtraining_config_copy.py

python3 -m paddle.distributed.launch --log_dir=./logs/vitbase_jointraining --gpus="0,1"  ./ufo_train.py --config-file ${config} #--resume 
