...
sample_num = 7000
epochs=30
dataloader.train.task_loaders.segmentation.total_batch_size = 2   # 7k samples 100e 
dataloader.train.task_loaders.fgvc.total_batch_size = 8  # 8.1k 300e
dataloader.train.task_loaders.trafficsign.total_batch_size = 2   # 6.1k  240e
...
optimizer.base_lr = optimizer.lr_multiplier.learning_rate = 1e-6
optimizer.lr_multiplier.solver_steps = [int(max_iters * 0.6)]


train.max_iter = max_iters
train.eval_period = int(0)
train.checkpointer.period = int(iters_per_epoch )
train.checkpointer.max_to_keep=20
train.init_checkpoint = 'pretrained/dino_vit-base_paddle.pdmodel'
# train.init_checkpoint = 'outputs/vitbase_joint_training/0801model_final.pdmodel'
