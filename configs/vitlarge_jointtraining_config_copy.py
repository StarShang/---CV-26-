    ...
    heads=L(OrderedDict)(
        ...
        trafficsign=L(DETR)(
            transformer=L(DINOTransformer)(
                            ...
                            backbone_feat_channels=[1024, 1024, 1024, 1024],
                            num_levels=4,
...
dataloader.train.task_loaders.fgvc.total_batch_size = 2   # 8.1k 300e
